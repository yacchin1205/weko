...
docker-compose exec -T postgresql psql -U invenio -d invenio -f /tmp/item_type.sql
...
docker-compose exec -T postgresql psql -U invenio -d invenio -f /tmp/resticted_access.sql
