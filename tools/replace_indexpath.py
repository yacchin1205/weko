...
def get_delete_records():
    ...
    sql_delete_records = '''
    SELECT 
        pidstore_pid.created      AS pidstore_pid_created, 
        pidstore_pid.updated      AS pidstore_pid_updated, 
        pidstore_pid.id           AS pidstore_pid_id, 
        ...
        pidstore_pid.status       AS pidstore_pid_status, 
        pidstore_pid.object_type  AS pidstore_pid_object_type, 
