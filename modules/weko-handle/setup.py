...
tests_require = [
    ...
    'pytest-invenio',
    'responses',
    f'invenio-db @ file://localhost{os.path.split(os.path.split(os.path.abspath(__file__))[0])[0]}/invenio-db#egg=invenio_db',
]
...
install_requires = [
    'Flask-BabelEx>=0.9.3',
    # TODO b2handle is not supported Python >= 3.8
    # 'b2handle>=1.1.2',
]
...
g = {}
with open(os.path.join('weko_handle', 'version.py'), 'rt') as fp:
    exec(fp.read(), g)
...
setup(
    ...
    url='https://github.com/RCOSDP/weko-handle',
    packages=packages,
    zip_safe=False,
