...
pytest test_basic_functionality.py
...
- **test_basic_functionality.py**: Basic functionality tests (homepage, search, navigation)
- **test_admin_functionality.py**: Admin interface tests (login, authentication)
